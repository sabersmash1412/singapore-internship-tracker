...
- At the [24 September audit](audits/2026-09-24.md), GovTech’s official page stated applications close **30 September 2026 at 12pm**. Catalogue presence and `filled=false` do not independently establish that the application window is open; students must check the linked official programme page.
